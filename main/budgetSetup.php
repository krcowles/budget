...
$nonmonthly = false;
/**
 * If there is a non-monthlies account, identify any autopays and update
 * the funding to match the budgeted funds. There may be excess funds
 * available, so all accounts may be funded as expected.
 */
if (in_array('Non-Monthlies', $account_names)) {
    include "../utilities/calculateNM.php";
}

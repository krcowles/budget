 ...
 * @return null
 */
function medrefErrors($errno, $errstr, $errfile, $errline)
{
 ...
 * @return null
 */
function medrefExceptions($exception)
{
    $lastTrace = getExceptionTraceAsString(new Exception);
...
function errorPage()
{
    ...
    include "../errors/user_error_page.html"; // send user error page
    exit(-1);
}
/**
...
function errorEmail($msg)
{
    ...
    $mail->addAddress($to, 'MedRefs User');
